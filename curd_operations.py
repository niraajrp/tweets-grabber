...
# def update_tweets(username, tweets, id):
#     query = """ UPDATE tweets
#                 SET username=%s, tweets=%s
#                 WHERE id=%s """
#     data = (username, tweets, id)
#     try:
#         conn = MySQLConnection(**db_config)
#         cursor = conn.cursor()
...
#     query = "DELETE FROM tweets WHERE id = %s"
#     try:
#         conn = MySQLConnection(**db_config)
#         cursor = conn.cursor()
...
if __name__ == '__main__':
    ...
    #     update_tweets(username, tweet, id_no)
    #
